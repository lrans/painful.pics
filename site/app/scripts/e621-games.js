...
e621games.guessSpecies.launchNewGame = function() {
	...
	e621games.guessSpecies.config.DATASOURCE = ds.fa;
	...
	e621games.guessSpecies.config.DATASOURCE.fetch(e621games.guessSpecies.config.NB_QUIZZ_ITEMS, e621games.guessSpecies.config.QUERY, function(detailedPost){
...
e621games.guessSpecies.datasourceChanged = function(){
	var newValue = $('.quizz-settings select[name=choices-imageSource]').val();
    e621games.guessSpecies.config.DATASOURCE = ds[newValue];
...
e621games.guessSpecies.start = function() {
    ...
    tools.fetchTemplate('quizz-fullpage', {}, function(page){
        ...
        tools.fetchTemplate('quizz-settings', {
			...
			$('select[name=choices-imageSource]').change(function(){
				e621games.guessSpecies.datasourceChanged();
            });
			e621games.guessSpecies.datasourceChanged();
